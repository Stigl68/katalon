...
WebUI.setText(findTestObject('Object Repository/Page_Elektronica, autos, kleding, verzamelo_9a2164/input_Voer uw trefwoord in__nkw'), 
    'Murphy&Nye waistcoat')

WebUI.click(findTestObject('Object Repository/Page_Elektronica, autos, kleding, verzamelo_9a2164/input_magical murphy_gh-btn'))

WebUI.click(findTestObject('Object Repository/Page_MurphyNye waistcoat  eBay/div_MURPHY  NYE  Waistcoat Womens XL Lined _e37b0b'))

WebUI.switchToWindowTitle('MURPHY & NYE Waistcoat Women\'s XL Lined Padded Duck Down Filled Pockets | eBay')

WebUI.click(findTestObject('Object Repository/Page_MURPHY  NYE Waistcoat Womens XL Lined _9537fa/a_Toevoegen aan winkelwagentje'))
