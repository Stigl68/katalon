...
WebUI.click(findTestObject('Object Repository/Page_murphynye  eBay/div_MURPHY  NYE Mens Sherpa Jacket UK 40 La_f73fe6'))

WebUI.switchToWindowTitle('MURPHY & NYE Mens Sherpa Jacket UK 40 Large Brown Cotton AL10 | eBay')

WebUI.click(findTestObject('Object Repository/Page_MURPHY  NYE Mens Sherpa Jacket UK 40 L_c9a5f5/a_Nu kopen'))

WebUI.click(findTestObject('Object Repository/Page_MURPHY  NYE Mens Sherpa Jacket UK 40 L_c9a5f5/span_Aankoop voltooien als bezoeker'))
